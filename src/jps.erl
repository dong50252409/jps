...
search(StartGrid, EndGrid, ValidFun) ->
    OpenGrids = add_grid(0, StartGrid, {0, []}, gb_trees:empty()),
    VisitedGrids = #{},
        ...
        false ->
            case gb_trees:take_smallest(OpenGrids) of
                ...
                {{_Score, Grid}, {G, Path}, OpenGrids1} ->
                    ...
                    {OpenGrids2, VisitedGrids1} = add_neighbour_girds(EndGrid, NeighbourGrids, G, [Grid | Path], OpenGrids1, VisitedGrids),
                    draw_map(OpenGrids2),
...
add_neighbour_girds(EndGrid, [Grid | T], G, Path, OpenGrids, VisitedGrids) ->
    G1 = G + g(Grid, EndGrid),
    Score = G1 + h(Grid, EndGrid),
    OpenGrids1 = add_grid(Score, Grid, {G1, Path}, OpenGrids),
    VisitedGrids1 = VisitedGrids#{Grid => true},
    add_neighbour_girds(EndGrid, T, G, Path, OpenGrids1, VisitedGrids1);
add_neighbour_girds(_EndGrid, [], _G, _Path, OpenGrids, VisitedGrids) ->
